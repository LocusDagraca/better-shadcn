...
export default function BetterNav({ base, page, description }: BetterNavProps) {
    return (
        <div className="flex flex-col gap-8">
            <BetterNavVariant1 base={base} page={page} description={description} />
            <BetterNavVariant2 base={base} page={page} description={description} />
            <BetterNavVariant3 base={base} page={page} description={description} />
        </div>
    )
}

export function BetterNavVariant1({ base, page, description }: BetterNavProps) {
    return (
...
export function BetterNavVariant2({ base, page, description }: BetterNavProps) {
    return (
...
export function BetterNavVariant3({ base, page, description }: BetterNavProps) {
    return (
        <div className="flex flex-col items-center justify-center gap-1 text-base bg-blue-800/20 rounded-full ">
            <div className=" flex items-center gap-3  bg-secondary/0 p-1 rounded-full px-1.5 text-center py-1">
                <BetterButton variant="ghost" size="icon-sm" className="text-muted-foreground rounded-full " tooltip="Back home">
                    {/* <Sidebar /> */}
                        ...
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbLink asChild>
                                    <Link href="/docs/components" className="text-base">{base}</Link>
                                </BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator className="size-4 text-muted-foreground/40 pt-1" />
                            <BreadcrumbItem className="flex items-center gap-1 bg-secondary  px-3 py-0.5 rounded-full">
