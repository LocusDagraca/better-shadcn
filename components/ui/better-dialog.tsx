...
function Dialog({ queryKey, ...props }: DialogProps) {
  ...
  return <DialogPrimitive.Root data-slot="dialog" {...controlledProps} {...props} />
}
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 sm:flex-row sm:justify-end bg-secondary/30  p-4 px-6 mt-6 border-t ",
        className
      )}
      {...props}
    />
